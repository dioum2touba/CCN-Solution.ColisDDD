...
{
    public partial class InitialMigration01052021 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Client_Region_RegionId",
                        column: x => x.RegionId,
                        principalTable: "Region",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(nullable: true),
                    LastName = table.Column<string>(nullable: true),
                    AgenceId = table.Column<int>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DateArrivée = table.Column<DateTime>(nullable: false),
                    ...
                    AgenceRecepteurId = table.Column<int>(nullable: false),
                    RegionRecepteurId = table.Column<int>(nullable: false),
                    RegionDepartId = table.Column<int>(nullable: false),
                    TypeDeColisId = table.Column<int>(nullable: false),
                    TypeDeColisId1 = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    //table.ForeignKey(
                    //    name: "FK_Colis_TypeDeColis_TypeDeColisId1",
                    //    column: x => x.TypeDeColisId1,
                    //    principalTable: "TypeDeColis",
                    //    principalColumn: "Id",
                    //    onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Colis_TypeDeColisId1",
                table: "Colis",
                column: "TypeDeColisId1");
